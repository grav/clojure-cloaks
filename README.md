...
| SCI / actual self-hosting probe | [Reproduction + results](examples/sci-self-host/) | Unmodified JVM source is blocked: SCI cannot interpret its own Java-interface-based Reified type. Full source-loading and isolated type checks reproduced; not a working self-hosted interpreter. |
