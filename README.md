...
| SCI / partial self-hosting | [Interpreted SCI + checks](examples/sci-self-host/) | Actual analyzer/evaluator source runs inside SCI; five runtime/type-support namespaces stay native. Sixteen behavior checks pass with host analyzer/eval entry points disabled. |
