...
| Clojurust / immutable history | [REPL + AOT demo](examples/clojurust/) | Native Linux ARM64: persistent snapshots, atom updates, undo, duplicate/Unicode greetings, and live function redefinition verified; relocated AOT executable matches interpreted output. |
