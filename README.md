...
| SCI / Rust + GraalVM | [Native library demo](examples/sci-rust/) | Linux ARM64: Rust calls GraalVM-compiled SCI through C FFI; expressions and relocation verified without a JVM process. |
